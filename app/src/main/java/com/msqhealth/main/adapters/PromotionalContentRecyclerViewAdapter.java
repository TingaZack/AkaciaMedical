...
public class PromotionalContentRecyclerViewAdapter extends RecyclerView.Adapter<PromotionalContentRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        System.out.println("DONE WRONG?: " + mValues.get(position).consumables);
            ...
            FirebaseDatabase.getInstance().getReference().child("users").child(user.getUid()).child("profile").addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.hasChild("debtorCode")) {
                        holder.mCardRelativeLayout.setVisibility(View.VISIBLE);
...
//                        If the debtor code does not exist, dont show the card

                        holder.mCardRelativeLayout.setVisibility(View.GONE);
                    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public final RelativeLayout mCardRelativeLayout;
        ...
        public ViewHolder(View view) {
            ...
            mCardRelativeLayout = (RelativeLayout) view.findViewById(R.id.relative_card);
        }
